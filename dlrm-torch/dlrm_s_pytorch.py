...
def dlrm_wrap(X, lS_o, lS_i, use_gpu, device, ndevices=1):
    with record_function("DLRM forward"):
        ...
        dlrm(X, *[torch.randn(X.shape[0], 128) for _ in range(26)])

        args = [X] + [torch.randn(X.shape[0], 128) for _ in range(26)]
...
class DLRM_Net(nn.Module):
    ...
    def forward(self, dense_x,
        # ly1 through ly26
        ly1, ly2, ly3, ly4, ly5, ly6, ly7, ly8, ly9, ly10, ly11, ly12, ly13, ly14, ly15, ly16, ly17, ly18, ly19, ly20, ly21, ly22, ly23, ly24, ly25, ly26
